...
const ModalDelete = ({ handleDelete, data }) => {
    ...
    return (
        <dialog id="my_modal_23" className="modal modal-bottom sm:modal-middle">
            <div className="modal-box text-center mx-auto">
                <div className="w-full flex justify-center">
                    <img src={warningIcon} alt="warning-icon" />
                </div>
                <h1 className="font-bold text-2xl text-[#1F2937] mt-5 mb-3">Hapus Pengguna</h1>
                <p className="text-[#6B7280] text-base font-medium max-w-[310px] mx-auto">Apa kamu yakin ingin menghapus pengguna ini ?</p>
